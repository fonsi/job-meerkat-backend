...
export const VULTR_NAME = 'vultr';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/vultr';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${VULTR_NAME} job post ${id}`,
        );
...
export const vultrScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
