...
const scrapJobPost = async ({
    id,
    url,
}: ScrapJobPostData): Promise<ScrappedJobPostResponse> => {
    try {
        ...
        const openaiJobPost = await openaiJobPostAnalyzer(
...
export const feeldScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
