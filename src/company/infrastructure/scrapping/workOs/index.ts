...
export const WORKOS_NAME = 'workos';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/workos';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${WORKOS_NAME} job post ${id}`,
        );
...
export const workOsScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
