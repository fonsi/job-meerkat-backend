...
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/golinks';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${GOLINKS_NAME} job post ${id}`,
        );
...
export const goLinksScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
