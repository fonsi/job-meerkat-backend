...
export const CRIBL_NAME = 'cribl';
const INITIAL_URL =
    'https://boards-api.greenhouse.io/v1/boards/cribl/jobs?content=true';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${CRIBL_NAME} job post ${id}`,
        );
...
export const criblScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
