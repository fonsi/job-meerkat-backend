...
export const RESEND_NAME = 'resend';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/resend';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${RESEND_NAME} job post ${id}`,
        );
...
export const resendScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
