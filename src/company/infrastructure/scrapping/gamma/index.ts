...
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/gamma';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${GAMMA_NAME} job post ${id}`,
        );
...
export const gammaScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
