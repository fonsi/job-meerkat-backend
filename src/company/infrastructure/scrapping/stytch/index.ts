...
export const STYTCH_NAME = 'stytch';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/stytch';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${STYTCH_NAME} job post ${id}`,
        );
...
export const stytchScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
