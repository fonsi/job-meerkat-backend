...
export const GLIDE_NAME = 'glide';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/glide';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${GLIDE_NAME} job post ${id}`,
        );
...
export const glideScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
