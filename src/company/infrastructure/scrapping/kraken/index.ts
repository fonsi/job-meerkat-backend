...
export const KRAKEN_NAME = 'kraken';
const ASHBY_COMPANY_NAME = 'kraken.com';
const KRAKEN_INITIAL_URL = `https://api.ashbyhq.com/posting-api/job-board/${ASHBY_COMPANY_NAME}`;
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${KRAKEN_NAME} job post ${id}`,
        );
