...
export const PREFECT_NAME = 'prefect';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/prefect';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${PREFECT_NAME} job post ${id}`,
        );
...
export const prefectScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
