...
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/sprig';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${SPRIG_NAME} job post ${id}`,
        );
...
export const sprigScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
