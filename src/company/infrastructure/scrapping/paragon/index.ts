...
export const PARAGON_NAME = 'paragon';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/paragon';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${PARAGON_NAME} job post ${id}`,
        );
...
export const paragonScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
