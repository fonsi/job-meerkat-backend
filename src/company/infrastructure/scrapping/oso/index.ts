...
export const OSO_NAME = 'oso';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/oso';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${OSO_NAME} job post ${id}`,
        );
...
export const osoScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
