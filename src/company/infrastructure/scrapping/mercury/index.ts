...
const INITIAL_URL =
    'https://boards-api.greenhouse.io/v1/boards/mercury/jobs?content=true';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${MERCURY_NAME} job post ${id}`,
        );
...
export const mercuryScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
