...
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/hex';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${HEX_NAME} job post ${id}`,
        );
...
export const hexScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
