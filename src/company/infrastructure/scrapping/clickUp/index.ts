...
export const CLICKUP_NAME = 'clickup';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/clickup';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${CLICKUP_NAME} job post ${id}`,
        );
...
export const clickUpScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
