...
export const AUTOMOX_NAME = 'automox';
const INITIAL_URL =
    'https://boards-api.greenhouse.io/v1/boards/automox/jobs?content=true';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${AUTOMOX_NAME} job post ${id}`,
        );
...
export const automoxScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
