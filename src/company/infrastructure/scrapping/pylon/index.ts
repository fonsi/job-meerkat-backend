...
export const PYLON_NAME = 'pylon';
const INITIAL_URL = 'https://api.ashbyhq.com/posting-api/job-board/pylon';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${PYLON_NAME} job post ${id}`,
        );
...
export const pylonScrapper: NewCompanyScrapper = ({ companyId }) => {
    return {
