...
export const HUMAN_INTEREST_NAME = 'human interest';
const HUMAN_INTEREST_INITIAL_URL =
    'https://job-boards.greenhouse.io/humaninterest';
...
const scrapJobPost = async ({
    ...
    try {
        ...
        const error = errorWithPrefix(
            e,
            `Error processing ${HUMAN_INTEREST_NAME} job post ${id}`,
        );
