...
import { getItem, putItem, scan } from 'shared/infrastructure/persistance/dynamodb';
import { DynamodbError } from 'shared/infrastructure/persistance/dynamodb/error/dynamodbError';
import { CompanyRepository, Create, GetAll, GetById } from 'company/domain/companyRepository';
