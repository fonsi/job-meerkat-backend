...
export type GetByOriginalIdAndCompanyId = (originalId: string, companyId: CompanyId) => Promise<JobPost>;
export type Close = (jobPostId: JobPostId, companyId: CompanyId, closedAt: number) => Promise<JobPost>;
