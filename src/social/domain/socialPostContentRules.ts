...
- Use the exact Jobmeerkat URLs provided for each platform (they include short tracking params). Do not strip query strings. On Bluesky/Threads the full URL length counts toward the limit — budget for it.
`.trim();
